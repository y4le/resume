...
// proxy (e.g. Tailscale Serve at https://<node>.ts.net/react-resume/). Set via
// `DEV_BASE_PATH=/react-resume/`. Production is unaffected (assets stay relative,
// which is what GitHub Pages at /react-resume/ needs).
...
module.exports = (env, argv) => {
  ...
  return {
    ...
    output: {
      ...
      // Relative asset URLs in dev: Tailscale Serve strips the /react-resume prefix
      ...
      // ('auto' → also relative, which is what GitHub Pages at /react-resume/ needs).
    ...
    devServer: {
      ...
      // hits wss://<node>.ts.net/react-resume/ws (Tailscale strips the prefix and the
